                    ...
                    <form method="POST" action="{{ route('update-profile') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                @else    
                                    <small class="form-text text-muted">Leave it if you dont want to change it</small>
                                @enderror
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    @error('current_password')
                                     ...
                                     @else    
                                        <small class="form-text text-muted">Current password is needed if you want to confirm changes</small>    
                                    @enderror
                                </div>
                            </div>
